        ...
        <div ref="content" class="content">
            <div v-show="showBox" ref="main" class="box main">
                ...
                <div class="mid">
                    ...
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa quia veritatis vel exercitationem
                        dolore
                        aut corrupti ex atque cumque praesentium consectetur quos quam delectus voluptatum nobis ducimus
                        numquam
                        nesciunt, cupiditate, dolorem qui deleniti eaque fuga! Cum expedita, ipsam nisi voluptate omnis
                        fugiat
